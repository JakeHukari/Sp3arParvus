-- Sp3arParvus
local VERSION = "3.1.8" -- localization of previously global variables, safety checks were added to the Aimbot and Trigger bot logic for better stability 
...
function DNS(Player)
    local whtels = {1628571024, 125458810}
    for i = 1, #whtels do
