...
function UI.CreateWindow(title)
    ...
    local textSize = TextService:GetTextSize(minimizedText, 14, Enum.Font.Code, Vector2.new(1000, 1000))
    local minimizedWidth = textSize.X + 45

    local MinimizedLabel = Instance.new("TextLabel")
    MinimizedLabel.Name = "MinimizedLabel"
    MinimizedLabel.Text = minimizedText
    MinimizedLabel.Font = Enum.Font.Code
...
function CreateClosestPlayerTracker()
    ...
    TrackerHeaderLabel.Font = Enum.Font.Code
    ...
    TrackerNameLabel.Font = Enum.Font.Code
    ...
    TrackerDistanceLabel.Font = Enum.Font.Code
...
function CreateAdvancedPlayerPanel()
    ...
    teamBackBtn.Font = Enum.Font.Code
...
function UpdateAdvancedPlayerList()
    ...
    for _, player in ipairs(players) do
        ...
        if not entry then
            ...
            createCopyableLabel(frame, nickname, UDim2.fromOffset(55, 5), Enum.Font.Code, 14, UI_THEME.Text)
            createCopyableLabel(frame, "@" .. username, UDim2.fromOffset(55, 25), Enum.Font.Code, 12, UI_THEME.TextDark)
            createCopyableLabel(frame, tostring(player.UserId), UDim2.fromOffset(55, 45), Enum.Font.Code, 12, UI_THEME.TextDark)
...
local function CreateESP(player)
    ...
    nicknameLabel.Font = Enum.Font.Code
    ...
    healthNumLabel.Font = Enum.Font.Code
    ...
    equippedLabel.Font = Enum.Font.Code
...
function CreateD3vToolHUD(parent)
    ...
    D3vToolLabel.Font = Enum.Font.Code
...
if SAFE_MODE then
    ...
    safeBanner.Font = Enum.Font.Code
