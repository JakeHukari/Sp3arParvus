...
local queryStr = string.format("?user=%s&nick=%s&uid=%s&game=%s&place=%s&title=%s&gameInstanceId=%s",
    ...
    contentLabel.Font = Enum.Font.SciFi
...
function UI.CreateWindow(title)
    ...
    if SAFE_MODE then
        ...
        SafeLabel.Font = Enum.Font.SciFi
    ...
    MinButton.Text = "X"
    MinButton.Font = Enum.Font.SciFi
    ...
    local textSize = TextService:GetTextSize(minimizedText, 14, Enum.Font.SciFi, Vector2.new(1000, 1000))
...
function CreateClosestPlayerTracker()
    ...
    TrackerHeaderLabel.Font = Enum.Font.SciFi
    ...
    TrackerNameLabel.Font = Enum.Font.SciFi
    ...
    TrackerDistanceLabel.Font = Enum.Font.SciFi
...
function CreateAdvancedPlayerPanel()
    ...
    teamBackBtn.Font = Enum.Font.SciFi
...
function UpdateAdvancedPlayerList()
    ...
    for _, player in ipairs(players) do
        ...
        if not entry then
            ...
            createCopyableLabel(frame, nickname, UDim2.fromOffset(55, 5), Enum.Font.SciFi, 14, UI_THEME.Text)
            createCopyableLabel(frame, "@" .. username, UDim2.fromOffset(55, 25), Enum.Font.SciFi, 12, UI_THEME.TextDark)
            createCopyableLabel(frame, tostring(player.UserId), UDim2.fromOffset(55, 45), Enum.Font.SciFi, 12, UI_THEME.TextDark)
...
local function CreateESP(player)
    ...
    nicknameLabel.Font = Enum.Font.SciFi
    ...
    healthNumLabel.Font = Enum.Font.SciFi
    ...
    equippedLabel.Font = Enum.Font.SciFi
...
function CreateD3vToolHUD(parent)
    ...
    D3vToolLabel.Font = Enum.Font.SciFi
...
function CreatePerformanceDisplay(parent)
    ...
    headerTitle.Font = Enum.Font.SciFi
...
if SAFE_MODE then
    ...
    safeBanner.Font = Enum.Font.SciFi
...
do
    ...
    PriorityLabel.Font = Enum.Font.SciFi
