...
function RefreshWaypointUI()
    ...
    for _, id in ipairs(keys) do
        ...
        delBtn.Text = "X"
        delBtn.Font = Enum.Font.ArialBold
...
function UI.CreateWindow(title)
    ...
    if SAFE_MODE then
        ...
        SafeLabel.Font = Enum.Font.ArialBold
    ...
    local textSize = TextService:GetTextSize(minimizedText, 14, Enum.Font.ArialBold, Vector2.new(1000, 1000))
    local minimizedWidth = textSize.X + 45

    local MinimizedLabel = Instance.new("TextLabel")
    MinimizedLabel.Name = "MinimizedLabel"
    MinimizedLabel.Text = minimizedText
    MinimizedLabel.Font = Enum.Font.ArialBold
...
function CreateClosestPlayerTracker()
    ...
    TrackerHeaderLabel.Font = Enum.Font.ArialBold
    ...
    TrackerNameLabel.Font = Enum.Font.ArialBold
    ...
    TrackerDistanceLabel.Font = Enum.Font.ArialBold
...
function CreateItemPanel()
    ...
    pfTitle.Font = Enum.Font.ArialBold
    pfTitle.TextSize = 12
...
function CreateAdvancedPlayerPanel()
    ...
    teamsBtn.Text = "🛡️"
    teamsBtn.Font = Enum.Font.ArialBold
    ...
    teamBackBtn.Font = Enum.Font.ArialBold
...
function UpdateTeamPanelList()
    ...
    for _, team in ipairs(teamList) do
        ...
        expandBtn.Font = Enum.Font.ArialBold
        ...
        if isExpanded then
            for _, player in ipairs(playersOnTeam) do
                ...
                pwBtn.Text = "W"
                pwBtn.Font = Enum.Font.ArialBold
                pwBtn.TextSize = 10
                ...
                pbBtn.Text = "B"
                pbBtn.Font = Enum.Font.ArialBold
                pbBtn.TextSize = 10
...
function UpdateAdvancedPlayerList()
    ...
    for _, player in ipairs(players) do
        ...
        if not entry then
            ...
            createCopyableLabel(frame, nickname, UDim2.fromOffset(55, 5), Enum.Font.ArialBold, 14, UI_THEME.Text)
            createCopyableLabel(frame, "@" .. username, UDim2.fromOffset(55, 25), Enum.Font.Arial, 12, UI_THEME.TextDark)
            createCopyableLabel(frame, tostring(player.UserId), UDim2.fromOffset(55, 45), Enum.Font.Arial, 12, UI_THEME.TextDark)
            ...
            distLbl.Text = "---"
            distLbl.Font = Enum.Font.ArialBold
            distLbl.TextSize = 12
...
local function UpdateItemPropertyPane(instance)
    ...
    for _, catName in ipairs(categories) do
        ...
        if catHasAny then
            ...
            catLabel.Font = Enum.Font.ArialBold
...
local function VisualizeItemInstance(instance, content, depth)
    ...
    for _, child in ipairs(children) do
        pcall(function()
            ...
            selectBtn.Font = Enum.Font.Arial
...
local function CreateESP(player)
    ...
    nicknameLabel.Font = Enum.Font.ArialBold
    ...
    usernameLabel.Font = Enum.Font.ArialBold
    ...
    healthNumLabel.Font = Enum.Font.ArialBold
    ...
    equippedLabel.Font = Enum.Font.ArialBold
...
function CreateD3vToolHUD(parent)
    ...
    D3vToolLabel.Font = Enum.Font.ArialBold
...
function ShowWorldHumList(page)
    ...
    refreshBtn.Font = Enum.Font.ArialBold
    ...
    for _, data in ipairs(humDataList) do
        ...
        editBtn.Text = "Edit"
        editBtn.Font = Enum.Font.ArialBold
        editBtn.TextSize = 12
...
if SAFE_MODE then
    ...
    safeBanner.Font = Enum.Font.Arial
...
do
    ...
    PriorityLabel.Font = Enum.Font.ArialBold
